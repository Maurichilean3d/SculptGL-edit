...
var TR = {
  ...
  sceneSelectMulti: 'Tap to add/remove selection',
  ...
  sculptTransformMode: 'Transform mode',
  sculptTransformTranslate: 'Translate',
  sculptTransformRotate: 'Rotate',
  sculptTransformScale: 'Scale',
  sculptTransformAxis: 'Transform axis',
  sculptTransformAxisAll: 'All axes',
  sculptTransformAxisX: 'X axis',
  sculptTransformAxisY: 'Y axis',
  sculptTransformAxisZ: 'Z axis',
  sculptTransformSpace: 'Transform space',
  sculptTransformSpaceWorld: 'World',
  sculptTransformSpaceLocal: 'Local',
  sculptTransformSpaceNormal: 'Normal',
